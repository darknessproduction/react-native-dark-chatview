...
import { idx } from "./idx";
import type { Offset, DarkChatViewPropType } from "./Types";
import { styles } from "./styles";

export class DarkChatView extends React.PureComponent<DarkChatViewPropType> {
  ...
  constructor(props: DarkChatViewPropType) {
    super(props);
  ...
  scrollTo(offset: Offset, animated: boolean = true) {
    if (Platform.OS === "ios") {
      NativeModules.DarkChatView.scrollTo(
  ...
  endRefresh() {
    if (Platform.OS === "ios") {
      NativeModules.DarkChatView.endRefresh(findNodeHandle(this._scrollView));
    } else if (Platform.OS === "android") {
  ...
  endLoading() {
    if (Platform.OS === "ios") {
      NativeModules.DarkChatView.endLoading(findNodeHandle(this._scrollView));
    } else if (Platform.OS === "android") {
...
const DarkChatViewNative = Animated.createAnimatedComponent(
  requireNativeComponent("DarkChatView", DarkChatView)
);

const DarkChatContentViewNative =
  Platform.OS === "ios" ? requireNativeComponent("DarkChatContentView") : View;
